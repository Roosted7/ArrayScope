# V/T/P-program execution record (2026-07-14 → 2026-07-15)

Verbatim Codex execution record of the V0–V4 visible-truth queue, the T1
measurement foundation, and the P1–P9 checkpoints as they were logged in
`docs/redesign/README.md`. Extracted 2026-07-16 when that README was
slimmed; evidence, never direction. Rejected experiments are indexed in
