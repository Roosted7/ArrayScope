# Completed gates N4–N7 and X1–X4 (archived 2026-07-02)

These gates are complete; their exit criteria and completion notes are preserved
here verbatim from the live roadmap. Current work is in `docs/roadmap.md`.
