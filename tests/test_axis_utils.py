...
AXIS_UTILS_PATH = Path(__file__).parents[1] / "arrayscope" / "axis_utils.py"
SPEC = importlib.util.spec_from_file_location("arrayscope_axis_utils_for_test", AXIS_UTILS_PATH)
