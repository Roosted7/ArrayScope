...
from arrayscope.window.display_frame import DisplayFrameKey, DisplayTilePayload, TiledValueSource
...
def _presentation():
    ...
    return DisplayTiledPresentation(
        ...
        montage_tile_source_ids={0: payload.source_id},
    )
...
def test_tiled_committer_keeps_fake_raster_out_of_committed_frame():
    ...
    assert view.commit["tile_payloads"] == presentation.tile_payloads
    ...
    assert frame.value_source.payloads == presentation.tile_payloads
