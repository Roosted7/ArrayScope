...
def test_make_montage_tiles_scalar_images_with_gap():
    ...
    result = montage.make_montage_from_images(images, columns=2, gap=1)
...
def test_make_montage_preserves_histogram_data():
    ...
    result = montage.make_montage_from_images(images, histogram_images=hist, columns=2, gap=0)
...
def test_make_montage_histogram_marks_gaps_as_nan_for_roi_stats():
    ...
    result = montage.make_montage_from_images(images, histogram_images=images, columns=2, gap=1)
